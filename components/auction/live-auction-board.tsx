            ...
            <>
                ...
                {currentPlayer.card_image_url ? (
                  ...
                  <div className="flex aspect-[4/5] items-center justify-center bg-gradient-to-br from-cyan/20 via-purple/10 to-magenta/20">
                    <div className="text-center">
                      <p className="text-sm uppercase tracking-[0.24em] text-gray-400">Player card</p>
              ...
              <div className="mt-6 grid gap-4 md:grid-cols-3">
                ...
                <div className="rounded-2xl border border-gold/20 bg-gradient-to-br from-gold/10 to-transparent p-4">
                  <p className="text-xs uppercase tracking-[0.2em] text-gray-400">Base price</p>
                ...
                <div className="rounded-2xl border border-lime/20 bg-gradient-to-br from-lime/10 to-transparent p-4">
                  <p className="text-xs uppercase tracking-[0.2em] text-gray-400">Going at</p>
        ...
        <div className="p-6 md:p-8">
          ...
          <div className="mt-6 rounded-3xl border border-purple/20 bg-gradient-to-br from-purple/[0.06] to-transparent p-6 backdrop-blur-sm">
            ...
            <div className="mt-4 space-y-3">
              ...
              }) : <p className="text-sm text-gray-400">No bids yet for this lot.</p>}
            </div>
          </div>
        </div>
      </div>
