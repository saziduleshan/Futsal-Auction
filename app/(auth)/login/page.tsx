  ...
  return (
    <div className="mx-auto flex min-h-[calc(100vh-88px)] max-w-7xl items-center px-4 py-16 md:px-6">
      <div className="grid w-full gap-8 lg:grid-cols-[0.95fr_1.05fr]">
          ...
          <div className="panel overflow-hidden p-8 md:p-10">
            <div className="relative">
              <div className="inline-flex h-14 w-14 items-center justify-center rounded-2xl bg-gradient-to-br from-lime to-cyan text-pitch">
              ...
              <form action="/api/auth/login" method="post" className="mt-8 space-y-5">
                ...
                <button className="w-full rounded-2xl bg-gradient-to-r from-lime to-cyan px-5 py-3 font-black uppercase tracking-[0.18em] text-pitch transition hover:from-white hover:to-white">
                  Login to dashboard
                </button>
              </form>
            </div>
